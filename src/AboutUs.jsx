...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      {<p className="plant_logo_left"><img src="https://cdn.pixabay.com/photo/2013/07/12/17/20/leaf-152047_1280.png" height='50px' width='50px' alt="" /></p>}
      <p className="about-us-content">
      ...
      {<p className="plant_logo_right"><img src="https://cdn.pixabay.com/photo/2013/07/12/17/20/leaf-152047_1280.png" height='50px' width='50px' alt="" /></p>}
